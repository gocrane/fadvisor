...
LDFLAGS = "-X github.com/gocrane/fadvisor/pkg/version.gitVersion=$(GIT_VERSION) \
                      -X github.com/gocrane/fadvisor/pkg/version.gitCommit=$(GIT_COMMIT_HASH) \
                      -X github.com/gocrane/fadvisor/pkg/version.gitTreeState=$(GIT_TREESTATE) \
                      -X github.com/gocrane/fadvisor/pkg/version.buildDate=$(BUILDDATE)"
